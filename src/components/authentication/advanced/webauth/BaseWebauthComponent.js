/**
 * BaseWebauthComponent.js
 * Base component for Webauth authentication
 */

import { EventEmitter } from '../../../core/events.js';
import { ValidationService } from '../../utils/validation/ValidationService.js';

export class BaseWebauthComponent extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
...
export default BaseWebauthComponent;
