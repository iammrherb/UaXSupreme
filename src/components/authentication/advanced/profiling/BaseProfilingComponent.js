/**
 * BaseProfilingComponent.js
 * Base component for Profiling authentication
 */

import { EventEmitter } from '../../../core/events.js';
import { ValidationService } from '../../utils/validation/ValidationService.js';

export class BaseProfilingComponent extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
...
export default BaseProfilingComponent;
