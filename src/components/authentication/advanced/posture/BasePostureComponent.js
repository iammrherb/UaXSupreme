/**
 * BasePostureComponent.js
 * Base component for Posture authentication
 */

import { EventEmitter } from '../../../core/events.js';
import { ValidationService } from '../../utils/validation/ValidationService.js';

export class BasePostureComponent extends EventEmitter {
  constructor(options = {}) {
    super();
    this.options = {
...
export default BasePostureComponent;
